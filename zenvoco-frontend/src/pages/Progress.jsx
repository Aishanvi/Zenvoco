...
const Progress = () => {
  ...
  if (!progressData) {
    return (
      <DashboardLayout>
        <div className="text-gray-900 dark:text-white p-10 flex items-center justify-center min-h-screen">
          <div className="flex flex-col items-center gap-4">
            <div className="w-10 h-10 border-4 border-blue-500 border-t-transparent rounded-full animate-spin"></div>
            <p className="text-gray-600 dark:text-gray-400 font-medium tracking-wide">Loading your progress...</p>
          </div>
        </div>
      </DashboardLayout>
    );
    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto space-y-10">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Track your long-term communication skills growth.</p>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-900/50 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-3xl p-10 relative overflow-hidden">
          ...
          <div className="h-80 w-full relative z-10">
            {timeline.length > 0 ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-2xl">
        ...
        <div className="bg-gray-50 dark:bg-gray-900/50 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-3xl p-10">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-max">
              <thead>
                <tr className="text-gray-600 dark:text-gray-400 border-b-2 border-gray-200 dark:border-gray-800">
              ...
              <tbody className="text-gray-700 dark:text-gray-300">
                {timeline.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="4" className="py-10 text-center text-gray-500 border border-dashed border-gray-200 dark:border-gray-800 rounded-xl mt-4">
