...
function Register() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-black bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-blue-900/20 via-black to-black relative overflow-hidden">
      ...
      <div className="bg-gray-900/50 backdrop-blur-xl p-10 rounded-3xl border border-gray-800 w-full max-w-md relative z-10 my-8">

        <div className="text-center mb-10">
          <h2 className="text-3xl font-extrabold text-white tracking-tight mb-2">
            Join <span className="text-blue-500">Zenvoco</span>
          </h2>
          <p className="text-gray-400 text-sm">Start your journey to fearless communication.</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white p-4 rounded-xl font-bold hover:bg-blue-500 transition-all duration-300 transform active:scale-[0.98] mt-4"
          >
            Create Account
          </button>
        </form>
