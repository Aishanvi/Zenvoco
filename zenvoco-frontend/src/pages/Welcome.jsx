...
function Welcome() {
  return (
    <>
      ...
      <div className="bg-white dark:bg-black text-gray-900 dark:text-white selection:bg-blue-500/30 overflow-x-hidden transition-colors duration-300">
        ...
        <section id="home" className="relative min-h-[90vh] md:min-h-screen flex flex-col justify-center items-center text-center px-6 pt-24 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
            ...
            <div className="inline-block px-4 py-2 border border-gray-200 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50 rounded-full text-blue-600 dark:text-blue-400 text-sm font-medium mb-8 backdrop-blur-md">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg md:text-xl md:leading-relaxed mb-12 max-w-2xl px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-5 items-center w-full sm:w-auto px-6">
              {(localStorage.getItem("token") && localStorage.getItem("token") !== "undefined" && localStorage.getItem("token") !== "null") ? (
                ...
                <>
                  ...
                  <Link
                    to="/login"
                    className="w-full sm:w-auto bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-800 px-10 py-5 rounded-xl font-bold text-lg text-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-800 hover:border-gray-400 dark:hover:border-gray-700 transition-all duration-300"
                  >
                    Sign In
                  </Link>
                </>
        ...
        <section id="how-it-works" className="py-24 md:py-32 flex flex-col justify-center items-center px-6 text-center bg-gray-50 dark:bg-gray-950 transition-colors duration-300">

          <h2 className="text-3xl md:text-5xl font-bold mb-4 tracking-tight">
            How does it <span className="text-blue-500">work?</span>
          </h2>
          <p className="text-gray-600 dark:text-gray-400 mb-16 max-w-xl text-lg">A simple three-step methodology to build your speaking muscles.</p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full">

            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-10 transition-all duration-300 group text-left shadow-sm dark:shadow-none hover:shadow-md">
        ...
        <section id="about" className="py-24 md:py-32 flex flex-col justify-center items-center px-6 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl bg-white/60 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-800 backdrop-blur-lg rounded-3xl p-12 md:p-20 shadow-xl dark:shadow-none">
            <h2 className="text-3xl md:text-5xl font-bold mb-8">
              Why we built Zenvoco
            </h2>

            <p className="text-gray-700 dark:text-gray-300 text-lg md:text-xl leading-relaxed text-left md:text-center font-medium">
              Zenvoco is <span className="text-gray-900 dark:text-white font-bold">not</span> an English learning app.
        ...
        {/* Footer */}
        <footer className="border-t border-gray-200 dark:border-gray-800 py-10 text-center text-gray-500 bg-gray-50 dark:bg-black transition-colors duration-300">
