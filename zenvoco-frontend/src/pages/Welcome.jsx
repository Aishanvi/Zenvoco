  ...
  return (
    <>
      ...
      <div className="bg-black text-white selection:bg-blue-500/30">
        ...
        {/* HERO SECTION */}
        <section id="home" className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 pt-24 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl max-w-5xl mx-auto flex flex-col items-center">
        ...
        <section id="how-it-works" className="py-32 flex flex-col justify-center items-center px-6 text-center bg-gray-950">
        ...
        {/* ABOUT SECTION */}
        <section id="about" className="py-32 flex flex-col justify-center items-center px-6 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl bg-gray-900/40 border border-gray-800 backdrop-blur-lg rounded-3xl p-12 md:p-20">
            ...
            <p className="text-gray-300 text-xl leading-relaxed text-left md:text-center font-medium">
